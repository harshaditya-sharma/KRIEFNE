...
- **Call made (A):** §2 taxes halved — rate/dmg 2%→1%, 3%→1.5%, 4%→2%, 1%→0.5%; seek flight 5%→2.5%; aegis dash +10%→+5%; hull-weight flats ward/mirror 5→2, bulwark 4→2, stasis/wind 8→4; nanoweave speed 2/3/4/6/8/10→1/1.5/2/3/4/5. §1 families untouched. Faces + `suiteCards` regexes follow. Fightsim: 7 → 4 fails, all ±4s marginals (S6 +1.2, S21 −4.3 fast side, S31 +3.3, S99 +2.3); S61 balanced and S81 band+quiet recovered. S31's +31s mean shift (72→~103) is real slowness inside a marginal band miss — 2b's THRALL.hp lever can move it.
